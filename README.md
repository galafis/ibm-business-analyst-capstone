...
Este projeto representa o trabalho final do **IBM Business Analyst**, demonstrando competências avançadas na área. A plataforma desenvolvida oferece uma solução completa e funcional.

**Desenvolvido por:** Gabriel Demetrios Lafis  
**Certificação:** IBM Business Analyst  
...
This project represents the capstone work for the **IBM Business Analyst**, demonstrating advanced competencies in the field. The developed platform offers a complete and functional solution.

**Developed by:** Gabriel Demetrios Lafis  
**Certification:** IBM Business Analyst  
